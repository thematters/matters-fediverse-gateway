...
- Handoff output: `matters-server` commits `50e2219`, `bac7511`, `4761f78`, `f8d410b`, `af4dffb`, `3497556`, and `2ae14bf` provide the non-production exporter scaffold, local writer, CLI, eligibility gate, schema scaffold, optional strict enforcement, migration-safe default export behavior, docs, and targeted tests; current public API sample author is `charlesmungerai` with articles `1182465`, `1181808`, and `1181797`; local and public staging gateway probes passed; Misskey received one real public Matters Article through fresh `outbox/create`.

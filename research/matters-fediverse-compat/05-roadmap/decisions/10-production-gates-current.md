...
| Pilot final gate checklist | Prepared, not executed | `03-ops/production-pilot-final-gates-20260522.md` separates closed gates, blocking open gates, AWS verification commands, owner recommendations, and the go/no-go rule. |

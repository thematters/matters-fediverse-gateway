...
2. Continue G2-B from post-permission staging validation: complete browser UI QA for the Fediverse settings row, article edit override, and disabled-state copy on `matters.icu`.

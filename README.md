...
2. Continue G2-B from validated staging controls into the export trigger contract: define how publish/edit events enqueue or dry-run `federation-export-dev`, where decision reports are retained, and how operators can replay or suppress export jobs.
